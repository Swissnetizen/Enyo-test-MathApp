...
var CalculateDecimalPlaces = function(e) {
e += "";
var t = !1, n = 0;
for (i = 0; i < e.length; i++) t ? n += 1 : e[i] == "." && (t = !0);
return n;
};
...
AnswerKeyDown: function(e, t) {
t.keyCode == 13 && this.SubmitFunc();
},
OkFailPopup: function() {
this.NewProblem(), this.$.FailPopup.hide(), this.$.CorrectAnswer.content = "";
},
NewProblem: function() {
this.n1 = Math.floor(Math.random() * 10 + 1), this.n2 = Math.floor(Math.random() * 10 + 1), this.ProblemType = Math.floor(Math.random() * 4 + 1), this.$.Answer.hasNode().value = "";
switch (this.ProblemType) {
case 1:
this.CorrectResult = RoundNumber(this.n1 + this.n2, this.MaxDecimals), this.ProblemTypeString = "+";
break;
case 2:
this.CorrectResult = RoundNumber(this.n1 - this.n2, this.MaxDecimals), this.ProblemTypeString = "-";
break;
case 3:
this.CorrectResult = RoundNumber(this.n1 * this.n2, this.MaxDecimals), this.ProblemTypeString = "x";
break;
case 4:
this.CorrectResult = RoundNumber(this.n1 / this.n2, this.MaxDecimals), this.ProblemTypeString = "/";
}
return this.$.Problem.content = this.n1 + " " + this.ProblemTypeString + " " + this.n2 + "=", this.$.Problem.render(), !0;
},
SubmitFunc: function(e, t) {
RoundNumber(this.$.Answer.hasNode().value, 2) == this.CorrectResult ? this.NewProblem() : (this.$.CorrectAnswer.content = "The Correct Answer was: " + this.CorrectResult, this.$.CorrectAnswer.render(), this.$.FailPopup.show());
}
});
